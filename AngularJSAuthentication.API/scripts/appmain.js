    ...
    return $routeProvider.when("/", {
      ...
      .when("/UnconfirmedGR/:id", {
        ...
        .when("/product", {
            ...
            templateUrl: "/views/ItemCategory/Product.html"
        })
        .when("/IR", {
        ...
        .when("/itemMasterNew", {
            ...
            templateUrl: "/views/ItemCategory/itemMasterNew.html"
        })
        ...
        .when("/POAssignment", {
            controller: "CreatePoAssignmentController",
            templateUrl: "/views/Delivery/POAssignment.html"

        })

        .when("/POAssignmentDetails", {
            controller: "POAssignmentController",
            templateUrl: "/views/PurchaseOrder/POAssignmentDetails.html"

        })

        .when("/GoodRecivedNew", {
            controller: "GoodRecivedControllerNew",
            templateUrl: "/views/PurchaseOrder/GoodRecivedNew.html"

        })
        //.when("/POAssignment", {
        //    controller: "CreateDeliveryAssignmentController.js",
        //    templateUrl: "views/Delivery/POAssignment.html"
        //})
        ...
        .when("/RequestedItems", {
            controller: "RequestedItemsController",
            templateUrl: "/views/ItemCategory/RequestedItems.html"
        })
...
var serviceBase = 'https://adminhindmud.moreyeahs.in/';    //
//var serviceBase = 'https://erp.moreyeahs.in/';
//var serviceBase = 'http://localhost:26265/';  //local
//var serviceBase='http://192.168.1.183:8080/'
//var serviceBase = 'http://103.15.67.124:8084/';
...
app.run(['authService', '$rootScope', 'CurrencyManagementLocalStorageService', '$location', function (authService, $rootScope, CurrencyManagementLocalStorageService, $location) {
